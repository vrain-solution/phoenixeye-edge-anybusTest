...
*/
   ...
   #define ABCC_CFG_OP_MODE_SETTABLE                  ( TRUE )
      ...
      /*
      ** '0' is an illegal opmode value, it is used here to prevent the driver
      ** from starting with an erroneous but legal value if ABCC_CFG_OP_MODE_GETTABLE
      ** is changed to an invalid setting.
      */
      #define ABCC_CFG_ABCC_OP_MODE_30                0
   #endif
      ...
      ** is changed to an invalid setting.
      */
      #define ABCC_CFG_ABCC_OP_MODE_40                0
   #endif
#endif
...
*/
   ...
   #define ABCC_CFG_MODULE_ID_PINS_CONN               ( TRUE )
      ...
      /*
      ** '1' is for a passive ABCC, it is used here to prevent the driver from
      ** starting with an erroneous but legal value if ABCC_CFG_MODULE_ID_PINS_CONN
      ** is changed to an invalid setting.
      */
      #define ABCC_CFG_ABCC_MODULE_ID                 1
   #endif
#endif
