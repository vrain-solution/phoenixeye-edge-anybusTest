...
**
** The default linker settings in IAR EWARM seems to assign all runtime
** variables to the DTCM-RAM, but the DMA controllers that services the I/O
** interfaces can't reach that memory directly.
**
